...
- (void)configureSession
{
	...
	*/
	...
	// Add video input.
	AVCaptureDevice *videoDevice = [AVCamCameraViewController deviceWithMediaType:AVMediaTypeVideo preferringPosition:AVCaptureDevicePositionBack];
...
- (IBAction)changeCamera:(id)sender
{
	...
	dispatch_async( self.sessionQueue, ^{
		...
		AVCaptureDevice *videoDevice = [AVCamCameraViewController deviceWithMediaType:AVMediaTypeVideo preferringPosition:preferredPosition];
